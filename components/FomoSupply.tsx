...
export default function FomoSupply() {
  ...
  return (
    <div className="hidden md:block lg:w-[250px] xl:w-[300px] 2xl:w-[330px]">
      <div className="bg-[#1E2220] rounded-lg lg:p-3 xl:p-4 ">
        ...
        <div className="bg-gradient-to-r from-blue-500 to-purple-700 rounded-xl lg:px-2 xl:px-2.5 py-2.5 2xl:py-4 my-2.5">
      ...
      <div className="bg-[#1E2220]/75 rounded-lg lg:p-3 xl:p-4 mt-4">
        <div className="bg-gradient-to-r from-[#D129FA] to-[#1EE0AF] rounded-lg py-3 lg:px-2 xl:px-4 mb-3">
        ...
        <div
          ...
          className="bg-[#1E2220] hover:bg-[#262827] transition-all cursor-pointer text-[#883CE3] text-md 2xl:text-lg font-semibold text-center rounded-lg p-2.5"
        >
          Stake $FOMO
        </div>
      </div>
