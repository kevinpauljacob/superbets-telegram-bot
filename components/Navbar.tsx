...
export default function Navbar() {
  ...
  return (
    <div className="bg-[#121418] text-white flex flex-col justify-between p-3.5 w-[260px] h-[calc(100vh-104px)]">
      <div>
        ...
        <div>
          <div className="mt-4">
            <div className="flex items-center">
              <p className="flex items-center">
                <Image src={dollar} alt="" width={14} height={14} />
                <span className="ml-2">FOMO: Exit</span>
              </p>
              <Image
                src={upArrow}
                alt=""
            ...
            <ul className="mt-1 pl-8">
              {fomoToken.map((token, index) => (
                <li key={index} className="flex items-center">
                  <Image src={token.src} alt="" width={14} height={14} />
                  <span className="ml-2">${token.token}</span>
                </li>
              ))}
            </ul>
          </div>
          <div className="mt-4">
            <div className="flex items-center">
              <p className="flex items-center">
                <Image src={play} alt="" width={14} height={14} />
                <span className="ml-2">FOMO: Play</span>
              </p>
              <Image
                src={downArrow}
                alt=""
