    ...
    <button
      ...
      className={`${
        active
          ...
          : "bg-transparent hover:bg-[#7F71FF] focus:bg-[#4C3ECC] text-opacity-50 hover:text-opacity-90"
      } transform rounded-[5px] w-full md:w-auto px-[0.8rem] sm:px-[1.2rem] py-2 font-medium tracking-wider font-sans text-sm text-white transition duration-200 flex justify-center items-center`}
    >
      {label}
    </button>
  );
