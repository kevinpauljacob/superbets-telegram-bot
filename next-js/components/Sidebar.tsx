      ...
      {sidebar ? (
        ...
        >
          <div className="w-full flex flex-col items-center">
            ...
            <div className={`${topIconCss}`} onClick={() => router.push('/')}>
          ...
          <div className="w-full flex flex-col items-center mb-2">
            <div className={`${bottomIconCss}`} onClick={() => router.push('/')}>
...
export const OpenSidebar = ({
  ...
  return (
    <>
      ...
      >
        <Link href="https://twitter.com/" className={`${openLinkCss}`} target="_blank">
          <Twitter className="w-5 h-5" />
          Twitter
        </Link>
        <Link href="https://birdeye.so/" className={`${openLinkCss}`} target="_blank">
          <Birdeye className="w-5 h-5 text-white" />
          Birdeye
        </Link>
        <Link href="https://web.telegram.org/a/" className={`${openLinkCss}`} target="_blank">
