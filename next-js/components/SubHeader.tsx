  ...
  return (
    <div className="flex flex-col w-full z-[80] absolute top-0 right-0">
      ...
      >
        ...
        <div className={`border-2 border-white border-opacity-5 rounded-[5px] p-3 cursor-pointer ml-3 ${showLiveStats ? "bg-[#d9d9d9] bg-opacity-10" : ""}`} onClick={() => setShowLiveStats(!showLiveStats)}>
