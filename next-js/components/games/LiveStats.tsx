    ...
    <Draggable bounds="parent" handle=".handle" nodeRef={nodeRef}>
      ...
      >
        <div className="handle w-full h-16 flex flex-row items-center justify-between p-5 cursor-move select-none">
          ...
          <div className="flex flex-row gap-2">
            ...
            >
              ...
              >
                <path
                  d="M3.74913 12.25C2.90703 11.4109 2.33321 10.3404 2.10048 9.17461C1.86774 8.00878 1.98658 6.80009 2.44192 5.70191C2.89727 4.60373 3.66858 3.66558 4.65799 3.00649C5.6474 2.3474 6.8103 1.9971 7.99913 2.00002"
                  stroke="white"
                />
                <path
                  d="M12.25 3.75C13.0921 4.58917 13.6659 5.65958 13.8987 6.82541C14.1314 7.99124 14.0125 9.19993 13.5572 10.2981C13.1019 11.3963 12.3305 12.3344 11.3411 12.9935C10.3517 13.6526 9.18883 14.0029 8 14"
                  stroke="white"
                />
            ...
            <div
              ...
              onTouchStart={() => setShowLiveStats(false)}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
        ...
        <div className="flex flex-col grow p-4 relative select-none">
          <div
            className="w-full h-[41px] bg-[#202329] rounded-md cursor-pointer flex flex-row items-center justify-between p-3"
          ...
          >
            ...
            >
              <path
                d="M5.46967 6.53043C5.76256 6.82332 6.23744 6.82332 6.53033 6.53043L11.3033 1.75746C11.5962 1.46457 11.5962 0.989692 11.3033 0.696799C11.0104 0.403906 10.5355 0.403906 10.2426 0.696799L6 4.93944L1.75736 0.696799C1.46447 0.403906 0.989593 0.403906 0.696699 0.696799C0.403806 0.989692 0.403806 1.46457 0.696699 1.75746L5.46967 6.53043ZM5.25 6V6.0001H6.75V6H5.25Z"
                fill="white"
              />
            </svg>
          </div>
          ...
          {isDropdownOpen && (
            <div className="absolute w-[89%] mt-12 p-2 max-h-40 bg-[#202329] border-2 border-white border-opacity-5 rounded-md overflow-y-auto modalscrollbar">
              {games.map((game, index) => (
                <div
                  key={index}
                  className="w-full h-8 flex flex-row items-center justify-between p-3 cursor-pointer hover:bg-[#30363D] rounded-md"
                  onClick={() => {
          ...
          <div className="w-full flex flex-row mt-3">
            ...
            <div className="w-1/2 flex flex-col bg-[#202329] rounded-lg p-2 ml-1">
              ...
              <div className="text-white text-[12px] font-chakra flex flex-row items-center justify-end">
                <span
                  className={data.pnl > 0 ? "text-[#72F238]" : "text-[#F1323E]"}
                >
                  {data.pnl > 0 ? "+" : ""}
                  {data.pnl.toFixed(4)}
                </span>
        ...
        <div className="bg-[#202329] grow m-4 mt-0 rounded-lg flex flex-col p-3 overflow-hidden">
          <div className="text-white text-[12px] font-chakra flex flex-row items-center justify-start">
            ...
            >
              <g opacity="0.5">
                ...
                <path d="M6.5625 7H7.4375" stroke="#F0F0F0" strokeWidth="0.5" />
                <path
                  d="M8.3125 5.6875C8.3125 5.6875 7.875 5.25 7.4375 5.25H6.5625"
                  stroke="#F0F0F0"
                  strokeWidth="0.5"
