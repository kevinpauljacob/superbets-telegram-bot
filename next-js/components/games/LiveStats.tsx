...
export default function LiveStats() {
    ...
    return (
        <Draggable bounds="parent" handle=".handle">
            <div className={`absolute m-2 w-80 h-[30rem] bg-[#121418] border border-white/10 rounded-lg flex flex-col ${showLiveStats ? "" : "hidden"}`} style={{
                zIndex: 99999999
            }}>
                ...
                <div className='flex flex-col grow p-4 relative select-none'>
                    <div className='w-full h-12 bg-[#202329] rounded-md cursor-pointer flex flex-row items-center justify-between p-3' onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                        <h1 className='text-white text-lg font-chakra uppercase'>{liveCurrentStat}</h1>
                    ...
                    {isDropdownOpen && (
                        <div className='absolute w-[89%] mt-14 p-2 max-h-40 bg-[#202329] rounded-md overflow-y-auto nobar'>
                            {games.map((game, index) => (
                                <div key={index} className='w-full h-8 flex flex-row items-center justify-between p-3 cursor-pointer hover:bg-[#30363D] rounded-md' onClick={() => {
                                    ...
                                    <h1 className='text-white text-md font-chakra uppercase'>{game}</h1>
                                </div>
                            ))}
                        </div>
                    )}
                    ...
                    <div className='w-full flex flex-row mt-3'>
                        <div className='w-1/2 flex flex-col bg-[#202329] rounded-lg p-2 mr-1'>
                            <div className='text-sm text-[#94A3B8] font-chakra text-left'>Wagered</div>
                            <div className='text-white text-lg font-chakra flex flex-row items-center justify-end'>
                                <span>
                                    {data.wagered.toFixed(4)}
                                </span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 14 14" fill="none" className="ml-1">
                                    <g opacity="0.5">
                        ...
                        <div className='w-1/2 flex flex-col bg-[#202329] rounded-lg p-2 ml-1'>
                            <div className='text-sm text-[#94A3B8] font-chakra text-left'>Profit</div>
                            <div className='text-white text-lg font-chakra flex flex-row items-center justify-end'>
                    ...
                    <div className='w-full flex flex-row mt-3'>
                        <div className='w-1/2 flex flex-col bg-[#202329] rounded-lg p-2 mr-1'>
                            <div className='text-sm text-[#94A3B8] font-chakra text-left'>Wins</div>
                            <div className='text-lg font-chakra flex flex-row items-center justify-end text-[#72F238]'>
                                {data.wins}
                            </div>
                        </div>

                        <div className='w-1/2 flex flex-col bg-[#202329] rounded-lg p-2 ml-1'>
                            <div className='text-sm text-[#94A3B8] font-chakra text-left'>Losses</div>
                            <div className='text-lg font-chakra flex flex-row items-center justify-end text-[#F1323E]'>
                                {data.losses}
                            </div>
                        </div>
                    </div>
