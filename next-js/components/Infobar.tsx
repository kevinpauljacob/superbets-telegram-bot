...
export default function InfoBar() {
  ...
  return (
    <div className="w-full min-h-[2rem] mt-1 z-[100] bg-[linear-gradient(90deg,#1D3B7C_0%,#1D3B7C_100%)] text-[#E7E7E7] text-opacity-70 flex items-center justify-center text-xs gap-5">
